export const dict = {
  ...
  "context.stats.currentContextTokens": "Tokeny bieżącego kontekstu",
  "context.stats.totalTokens": "Całkowita liczba tokenów",
  "context.stats.totalExecutionTime": "Całkowity czas wykonania",
  "context.stats.subagents": "Podagenci",
  "context.stats.totalSubagents": "Łącznie podagentów",
  "context.stats.subagentTokens": "Tokeny podagenta",
  "context.stats.subagentNumber": "Podagent {{index}}",
  "context.stats.subagentNumberTokens": "Tokeny podagenta {{index}}",
  "context.stats.subagentNumberExecutionTime": "Czas wykonania podagenta {{index}}",
  ...
  "context.usage.currentContextTokens": "Tokeny bieżącego kontekstu",
  "context.usage.subagentTokens": "Tokeny podagenta",
  "context.usage.totalTokens": "Całkowita liczba tokenów",
