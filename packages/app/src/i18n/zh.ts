...
export const dict = {
  ...
  "context.stats.currentContextTokens": "当前上下文 token",
  "context.stats.totalTokens": "总 token",
  "context.stats.totalExecutionTime": "总执行时间",
  "context.stats.subagents": "子代理",
  "context.stats.totalSubagents": "子代理总数",
  ...
  "context.stats.subagentNumberExecutionTime": "子代理 {{index}} 执行时间",
  ...
  "context.usage.currentContextTokens": "当前上下文 token",
