export const dict = {
  ...
  "context.stats.currentContextTokens": "Токены текущего контекста",
  "context.stats.totalTokens": "Всего токенов",
  "context.stats.totalExecutionTime": "Общее время выполнения",
  "context.stats.subagents": "Субагенты",
  "context.stats.totalSubagents": "Всего субагентов",
  "context.stats.subagentTokens": "Токены субагентов",
  "context.stats.subagentNumber": "Субагент {{index}}",
  "context.stats.subagentNumberTokens": "Токены субагента {{index}}",
  "context.stats.subagentNumberExecutionTime": "Время выполнения субагента {{index}}",
  ...
  "context.usage.currentContextTokens": "Токены текущего контекста",
  "context.usage.subagentTokens": "Токены субагентов",
  "context.usage.totalTokens": "Всего токенов",
