export const dict = {
  ...
  "context.stats.currentContextTokens": "رموز السياق الحالي",
  "context.stats.totalTokens": "إجمالي الرموز",
  "context.stats.totalExecutionTime": "إجمالي وقت التنفيذ",
  "context.stats.subagents": "الوكلاء الفرعيون",
  "context.stats.totalSubagents": "إجمالي الوكلاء الفرعيين",
  "context.stats.subagentTokens": "رموز الوكيل الفرعي",
  "context.stats.subagentNumber": "الوكيل الفرعي {{index}}",
  "context.stats.subagentNumberTokens": "رموز الوكيل الفرعي {{index}}",
  "context.stats.subagentNumberExecutionTime": "وقت تنفيذ الوكيل الفرعي {{index}}",
  ...
  "context.usage.currentContextTokens": "رموز السياق الحالي",
  "context.usage.subagentTokens": "رموز الوكيل الفرعي",
  "context.usage.totalTokens": "إجمالي الرموز",
