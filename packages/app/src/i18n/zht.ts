...
export const dict = {
  ...
  "context.stats.currentContextTokens": "目前上下文 token",
  "context.stats.totalTokens": "總 token",
  "context.stats.totalExecutionTime": "總執行時間",
  "context.stats.subagents": "子代理",
  "context.stats.totalSubagents": "子代理總數",
  "context.stats.subagentTokens": "子代理 token",
  "context.stats.subagentNumber": "子代理 {{index}}",
  "context.stats.subagentNumberTokens": "子代理 {{index}} token",
  "context.stats.subagentNumberExecutionTime": "子代理 {{index}} 執行時間",
  ...
  "context.usage.currentContextTokens": "目前上下文 token",
  "context.usage.subagentTokens": "子代理 token",
  "context.usage.totalTokens": "總 token",
