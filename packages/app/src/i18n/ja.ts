export const dict = {
  ...
  "context.stats.currentContextTokens": "現在のコンテキストトークン",
  "context.stats.totalTokens": "総トークン数",
  "context.stats.totalExecutionTime": "合計実行時間",
  "context.stats.subagents": "サブエージェント",
  "context.stats.totalSubagents": "サブエージェント合計",
  "context.stats.subagentTokens": "サブエージェントトークン",
  "context.stats.subagentNumber": "サブエージェント {{index}}",
  "context.stats.subagentNumberTokens": "サブエージェント {{index}} トークン",
  "context.stats.subagentNumberExecutionTime": "サブエージェント {{index}} 実行時間",
  ...
  "context.usage.currentContextTokens": "現在のコンテキストトークン",
  "context.usage.subagentTokens": "サブエージェントトークン",
  "context.usage.totalTokens": "総トークン数",
