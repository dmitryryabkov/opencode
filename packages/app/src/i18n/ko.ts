export const dict = {
  ...
  "context.stats.currentContextTokens": "현재 컨텍스트 토큰",
  "context.stats.totalTokens": "총 토큰",
  "context.stats.totalExecutionTime": "총 실행 시간",
  "context.stats.subagents": "서브에이전트",
  "context.stats.totalSubagents": "총 서브에이전트",
  "context.stats.subagentTokens": "서브에이전트 토큰",
  "context.stats.subagentNumber": "서브에이전트 {{index}}",
  "context.stats.subagentNumberTokens": "서브에이전트 {{index}} 토큰",
  "context.stats.subagentNumberExecutionTime": "서브에이전트 {{index}} 실행 시간",
  ...
  "context.usage.currentContextTokens": "현재 컨텍스트 토큰",
  "context.usage.subagentTokens": "서브에이전트 토큰",
  "context.usage.totalTokens": "총 토큰",
