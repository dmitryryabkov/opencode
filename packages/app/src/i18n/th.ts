export const dict = {
  ...
  "context.stats.currentContextTokens": "โทเค็นบริบทปัจจุบัน",
  "context.stats.totalTokens": "โทเค็นทั้งหมด",
  "context.stats.totalExecutionTime": "เวลาทำงานทั้งหมด",
  "context.stats.subagents": "ซับเอเจนต์",
  "context.stats.totalSubagents": "ซับเอเจนต์ทั้งหมด",
  "context.stats.subagentTokens": "โทเค็นซับเอเจนต์",
  "context.stats.subagentNumber": "ซับเอเจนต์ {{index}}",
  "context.stats.subagentNumberTokens": "โทเค็นซับเอเจนต์ {{index}}",
  "context.stats.subagentNumberExecutionTime": "เวลาทำงานของซับเอเจนต์ {{index}}",
  ...
  "context.usage.currentContextTokens": "โทเค็นบริบทปัจจุบัน",
  "context.usage.subagentTokens": "โทเค็นซับเอเจนต์",
  "context.usage.totalTokens": "โทเค็นทั้งหมด",
