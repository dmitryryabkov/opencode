...
import { TaskEstimationTool } from "./task_estimation"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const estimationtool = yield* TaskEstimationTool
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          task_estimation: Tool.init(estimationtool),
